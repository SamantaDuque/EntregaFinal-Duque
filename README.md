...
2. Asegurate de que los archivos estén organizados en la estructura indicada arriba.
3. Abrí el archivo `index.html` con cualquier navegador moderno (Google Chrome, Firefox, Edge, etc).
4. Probá agregar productos al carrito, marcar si es tu primera compra, y finalizá la compra.
5. Podés recargar la página y ver que el carrito persiste gracias al uso de `localStorage`.

> 💡 Para empezar de cero, hacé clic en “Vaciar carrito”.
